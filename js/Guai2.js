...
Guai2.prototype.update = function(){
    if(this.game.f % 8 == 0 ){
        this.step++;
        if(this.step>6){
            this.step=0
...
Guai2.prototype.gaibianfx = function (fangxiang) {
...
Guai2.prototype.render = function(){
    this.game.ctx.drawImage(this.game.R["guai.png"],this.step*16,16*1,16,16,this.x,this.y,24,24);
}
function checkNo1(m){
    return m != 1;
}